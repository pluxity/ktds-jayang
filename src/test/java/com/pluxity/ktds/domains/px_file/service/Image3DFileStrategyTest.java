...
@SpringBootTest
@Transactional
class Image3DFileStrategyTest {

    @Value("${root-path}")
    private String rootPath;
    //    private final String rootPath = Paths.get("src", "test", "resources").toString();
    @Autowired
    ...
    void saveFile() throws IOException {
        ...
        Path zipFilePath = Paths.get("src", "test", "resources", "3dIcon.zip");
        ...
        Path entityFolder = Paths.get(rootPath, FileEntityType.ICON3D.getType());

        FileInfoDto fileInfoDto = fileInfoService.saveFile(file, FileEntityType.ICON3D, saveZipFile);
